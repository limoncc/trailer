...
>
	{#snippet children({ thumbItems })}
		<span
			...
			class={cn(
				"rounded-full bg-border data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5 relative grow overflow-hidden bg-border"
			)}
		>
